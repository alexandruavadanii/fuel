...
This document contains details about how to modify and extend OPNFV Fuel.

development workflow

build process breakdown

deploy process breakdown

Upstream dependencies (overview)

project layout (directory structure)


salt master container (build)
...
How to patch an upstream formula

How to add a new scenario

How to alter an existing scenario

How to alter state files
